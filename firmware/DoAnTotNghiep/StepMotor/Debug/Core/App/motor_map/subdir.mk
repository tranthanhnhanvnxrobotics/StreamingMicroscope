...
C_SRCS += \
../Core/App/motor_map/motor_map.c 

OBJS += \
./Core/App/motor_map/motor_map.o 

C_DEPS += \
./Core/App/motor_map/motor_map.d 


# Each subdirectory must supply rules for building sources it contributes
Core/App/motor_map/%.o Core/App/motor_map/%.su Core/App/motor_map/%.cyclo: ../Core/App/motor_map/%.c Core/App/motor_map/subdir.mk
...
clean: clean-Core-2f-App-2f-motor_map

clean-Core-2f-App-2f-motor_map:
	-$(RM) ./Core/App/motor_map/motor_map.cyclo ./Core/App/motor_map/motor_map.d ./Core/App/motor_map/motor_map.o ./Core/App/motor_map/motor_map.su

.PHONY: clean-Core-2f-App-2f-motor_map
