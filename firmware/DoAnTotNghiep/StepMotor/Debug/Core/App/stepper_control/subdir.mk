...
C_SRCS += \
../Core/App/stepper_control/stepper_control.c 

OBJS += \
./Core/App/stepper_control/stepper_control.o 

C_DEPS += \
./Core/App/stepper_control/stepper_control.d 


# Each subdirectory must supply rules for building sources it contributes
Core/App/stepper_control/%.o Core/App/stepper_control/%.su Core/App/stepper_control/%.cyclo: ../Core/App/stepper_control/%.c Core/App/stepper_control/subdir.mk
...
clean: clean-Core-2f-App-2f-stepper_control

clean-Core-2f-App-2f-stepper_control:
	-$(RM) ./Core/App/stepper_control/stepper_control.cyclo ./Core/App/stepper_control/stepper_control.d ./Core/App/stepper_control/stepper_control.o ./Core/App/stepper_control/stepper_control.su

.PHONY: clean-Core-2f-App-2f-stepper_control
